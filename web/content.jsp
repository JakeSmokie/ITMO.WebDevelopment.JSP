...
<jsp:useBean id="history" class="ru.jakesmokie.weblab2.beans.HistoryBean" scope="session"/>
<html>
<head>
            ...
            <div id="table">
                <table class="table table-sm table-hover">
                    ...
                    <%
                        ...
                        final List<AreaCheckServletResult> entries =
                                new ArrayList<>(history.getHistory());

                        entries.sort(Comparator.comparing(AreaCheckServletResult::getDate).reversed());
                    %>
                    <% for (final AreaCheckServletResult entry : entries) { %>
                    <tr>
                        <td>
                            <%= entry.getDate() %>
                        </td>
